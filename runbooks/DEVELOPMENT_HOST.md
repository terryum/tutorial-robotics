...
```text
이 checkout을 DEVELOPMENT mode로 사용한다. EXECUTION_MODEL.md와 AGENTS.md를 읽고 $bootstrap-host를 실행해. shared progress를 존중하고 현재 capabilities로 가능한 다음 tutorial 하나만 완료해.
```
