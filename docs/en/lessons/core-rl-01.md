<!-- pal:language:start -->
<p align="right">
  <a href="../../ko/lessons/core-rl-01.md" lang="ko">한국어</a> | <a href="core-rl-01.md" lang="en">ENGLISH</a>
</p>
<!-- pal:language:end -->
...
Symbols, units and assumptions: r: new/old probability ratio; A: advantage in reward units; maximize L.

Worked calculation (not a measured run result): r=1.3, A=2 → min(2.6,2.4)=2.4.

Practical connection: A successful update proves optimizer mechanics; evaluate a reloaded policy separately.
