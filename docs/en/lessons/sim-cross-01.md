<!-- pal:language:start -->
<p align="right">
  <a href="../../ko/lessons/sim-cross-01.md" lang="ko">한국어</a> | <a href="sim-cross-01.md" lang="en">ENGLISH</a>
</p>
<!-- pal:language:end -->
...
Symbols, units and assumptions: N samples; J matched joints; q rad; same initial state, torque and dt.

Worked calculation (not a measured run result): errors [0.01,-0.01] rad → RMSE=0.01 rad.

Practical connection: Solver and collision differences can accumulate despite matched commands.
