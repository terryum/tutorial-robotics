<!-- pal:language:start -->
<p align="right">
  <a href="../../ko/lessons/hw-enlight-01.md" lang="ko">한국어</a> | <a href="hw-enlight-01.md" lang="en">ENGLISH</a>
</p>
<!-- pal:language:end -->
...
Review the observations, prerequisites and per-run safety boundary for enlight read-only adapter and low-risk validation.
...
pal lesson run hw-enlight-01 --headless --json
```
...
`examples/hw-enlight-01/run.py` → `src/pai_lab/lessons/runner.py`;
...
[hw-enlight-02](./hw-enlight-02.md)
