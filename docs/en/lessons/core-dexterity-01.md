<!-- pal:language:start -->
<p align="right">
  <a href="../../ko/lessons/core-dexterity-01.md" lang="ko">한국어</a> | <a href="core-dexterity-01.md" lang="en">ENGLISH</a>
</p>
<!-- pal:language:end -->
...
Symbols, units and assumptions: n: joint count; r: dimensionless structural ratio.

Worked calculation (not a measured run result): 20 / 24 ≈ 0.833 (illustrative counts).

Practical connection: Match semantics by name and role, not equal indices.
...
```bash
pal lesson review core-dexterity-01 --run-dir .local/runs/core-dexterity-01/baseline-01 --notes "Explained measured results and one-variable comparison; inspected plots and renderings." --json
