...
```bash
pal lesson review core-fr3-01 --run-dir .local/runs/core-fr3-01/baseline-01 --comparison-run-dir .local/runs/core-fr3-01/comparison-01 --notes "측정 결과와 한 변수 비교를 설명하고 그래프와 렌더링을 확인했습니다." --json
