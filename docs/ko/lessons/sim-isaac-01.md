...
URDF import가 관절·관성·형상을 USD/PhysX로 변환합니다. 어댑터는 문서화된 Isaac Sim 5.1 importer API를 사용합니다. mesh 경로는 로컬 파생 URDF에서 해석하고 vendor 파일은 보존합니다. 버전 호환성은 WS1 실행 증거로 확인해야 합니다.
