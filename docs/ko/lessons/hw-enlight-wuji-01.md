...
Enlight와 Wuji 통합 읽기 전용 검증에 필요한 관측·선행 조건과 실행별 안전 경계를 검토합니다.

## Preflight

장비 setup·매뉴얼 참조: [Enlight](../setup/enlight.md), [Wuji Hand 2 Beta 2](../setup/wuji.md).
...
pal lesson run hw-enlight-wuji-01 --headless --json
```
...
`examples/hw-enlight-wuji-01/run.py` → `src/pai_lab/lessons/runner.py`;
